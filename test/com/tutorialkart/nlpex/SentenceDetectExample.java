package com.tutorialkart.nlpex;
...
public class SentenceDetectExample {
	...
	public void sentenceDetect() throws InvalidFormatException, IOException {
		String paragraph = "Pipi. Pupi; nose. Apache openNLP supports the most common NLP tasks, such as tokenization, sentence segmentation, part-of-speech tagging, named entity extraction, chunking, parsing, and coreference resolution. These tasks are usually required to build more advanced text processing services. OpenNLP also includes maximum entropy and perceptron based machine learning.";
		...
		System.out.println("You got "+ sentences.length+" sentences in the paragraph");
